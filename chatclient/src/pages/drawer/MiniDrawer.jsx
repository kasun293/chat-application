...
import Chat2 from "../communication/Chat2";
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        {/* <Divider /> */}
        <List>
          {["Chats", "Group Chats", "Add Contacts", "Settings"].map(
            (text, index) => (
              <ListItem key={text} disablePadding sx={{ display: "block" }}>
                <ListItemButton
                  onClick={() => handleMenueItemIndex(index)}
                  sx={[
                    {
                      minHeight: 48,
                      px: 2.5,
      ...
      >
        <DrawerHeader />
        {selectedIndex === 0 ? <Chat2 /> : null}
        {selectedIndex === 1 ? <Typography>Group Chats</Typography> : null}
        {selectedIndex === 2 ? <ContactList /> : null}
        {selectedIndex === 3 ? <Typography>Settings</Typography> : null}
      </Box>
    </Box>
  );
};
